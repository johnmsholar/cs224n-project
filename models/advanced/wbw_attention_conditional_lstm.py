...
class WBW_Attention_Conditonal_Encoding_LSTM_Model(Advanced_Model):
    ...
    def get_fn_names(self):
        ...
        """
        best_weights_fn = 'wbw_attention_conditional_lstm_best_stance.weights'
        curr_weights_fn = 'wbw_attention_conditional_lstm_curr_stance.weights'
        preds_fn = 'wbw_attention_conditional_encoding_lstm_predicted.pkl'
        best_train_weights_fn = 'wbw_attention_conditional_encoding_lstm_best_train_stance.weights'
    ...
    def add_prediction_op(self, debug): 
        ...
        if debug:
            ...
            debug_ops = [headline_x, body_x, h_seq_lengths, a_seq_lengths, headline_outputs, headline_state]
        else:
            debug_ops = None
